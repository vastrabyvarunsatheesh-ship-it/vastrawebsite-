...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen bg-ivory">
      ...
      {/* 3. Featured Couture Product Section */}
      <ProductSection
        title="ROYAL COUTURE SELECTIONS"
      ...
      {/* 5. Trending Ethnic Wear Section */}
      <ProductSection
        title="TRENDING ETHNIC ATTIRE"
        subtitle="Popular This Season"
        products={FEATURED_PRODUCTS.slice(1, 4)}
        viewAllHref="/category/kurtis"
        bgVariant="warm"
      />

      {/* 6. Brand Guarantee & Trust Features Bar */}
      <TrustFeatures />

      {/* 7. Client Reflections & Testimonials */}
      <TestimonialSlider />

      {/* 8. VIP Newsletter Subscription Section */}
      <NewsletterSection />
    </div>
  );
}
